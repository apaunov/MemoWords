...
{
    private static final String USAGE_STATISTICS_CHECK_KEY = "usage_statistics_check";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB)
        {
            ...
            CheckBoxPreference checkBoxPreference = (CheckBoxPreference) findPreference(USAGE_STATISTICS_CHECK_KEY);
            checkBoxPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener()
            {
                ...
                public boolean onPreferenceClick(Preference preference)
                {
                    ...
                    {
                        MainActivity.getFirebaseAnalytics().setAnalyticsCollectionEnabled(false);
                    }
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment
    {
        ...
        public void onCreate(Bundle savedInstanceState)
        {
            ...
            {
                // API 14+
                SwitchPreference switchPreference = (SwitchPreference) findPreference(USAGE_STATISTICS_CHECK_KEY);
